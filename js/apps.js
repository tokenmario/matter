...
const sttaddr = "0x2C9E8D469f240BdC00A67E92969b71a64E6FE8B5";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x2C9E8D469f240BdC00A67E92969b71a64E6FE8B5";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://mariotoken.org?ref=' + document.getElementById('refaddress').value;
        }
    }
}
